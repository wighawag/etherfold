...
// NEVER SET IT
// ---------------------------------------------------------------------------
// The question ADR-0073 turns on: `alwaysFetchTimestamps` and
// `alwaysFetchTransactions` are being deleted from `ProvidedStreamConfig`, and
// for every deployment that never SET one that deletion has to be free -- same
