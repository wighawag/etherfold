...
- [ ] Both the raw (20.5 MB) and gzipped (0.6 MB) forms are accounted for, and the report distinguishes transfer bytes from parsed-in-memory cost rather than quoting one as the other.
