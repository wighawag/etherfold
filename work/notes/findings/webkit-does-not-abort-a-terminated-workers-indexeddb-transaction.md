...
1. ~~**File it.**~~ DONE, 2026-09-13: [WebKit 324094](https://bugs.webkit.org/show_bug.cgi?id=324094), NEW, Website Storage, severity Major, with the standalone reproduction attached, plus a comment on [251203](https://bugs.webkit.org/show_bug.cgi?id=251203) offering this as the trigger that report has never had. What is left is waiting, and re-testing when it moves.
